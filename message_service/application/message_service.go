...
func (service *MessageService) AddMessage(message *domain.Message, participants domain.Participants) error {
	return service.store.AddMessage(message, participants)
}
